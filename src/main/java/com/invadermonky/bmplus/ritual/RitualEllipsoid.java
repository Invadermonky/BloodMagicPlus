...
import com.invadermonky.bmplus.util.ItemStackHelper;
...
public class RitualEllipsoid extends Ritual {
    public static final String name = "ellipseRitual";
    ...
    public void performRitual(IMasterRitualStone masterRitualStone) {
        ...
        BlockPos masterPos = masterRitualStone.getBlockPos();
                AreaDescriptor chestRange = this.modableRangeMap.get(CHEST_RANGE);
        ...
        if (currentEssence < getRefreshCost()) {
            ...
            return;
                ...
                AreaDescriptor sphereRange = this.modableRangeMap.get(SPHEROID_RANGE);
            ...
            if (tileInventory.hasCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, EnumFacing.DOWN)) {
                ...
                for (int invSlot = 0; invSlot < itemHandler.getSlots(); invSlot++) {
                    ItemStack stack = itemHandler.extractItem(invSlot, 1, true);
                                        if (ItemStackHelper.isEmpty(stack) || !(stack.getItem() instanceof ItemBlock))
                        continue;
...
//
                                ...
                                //MODIEFIED: masterRitualStone.getOwnerNetwork().syphon(masterRitualStone.ticket(getRefreshCost()));
